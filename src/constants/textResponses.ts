 ...
 * --- Responses ---
 *
 * This file contains every random conversation piece that Pippin knows.
 ...
 *    https://github.com/AverageHelper/Pippin/blob/main/CODE_OF_CONDUCT.md
 */
...
export const phrases: ResponseRepository = [
	...
	({ otherMember: m, otherUser: u }) =>
		...
		} ALWAYS submits my favorite movies! (and I'm not just saying that)`,
